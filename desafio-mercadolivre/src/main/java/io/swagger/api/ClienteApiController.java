...
import io.swagger.custom.service.ClienteService;
...
public class ClienteApiController implements ClienteApi {
    ...
    public ResponseEntity<Void> alteraCliente(@ApiParam(value = "",required=true) @PathVariable("codigoCliente") String codigoCliente,@ApiParam(value = "" ,required=true) @Valid @RequestBody Cliente cliente_) {

        try {
        	return clienteService.alteraCliente(codigoCliente, cliente_);
        } catch (Exception e) {
    ...
    public ResponseEntity<Cliente> cadastraCliente(@ApiParam(value = ""  )  @Valid @RequestBody Cliente cliente_) {
            ...
            try {
            	return clienteService.cadastraCliente(cliente_);
            } catch (Exception e) {
    ...
    public ResponseEntity<Void> excluiCliente(@ApiParam(value = "",required=true) @PathVariable("codigoCliente") String codigoCliente) {
        try {
        	return clienteService.excluiCliente(codigoCliente);
        } catch (Exception e) {
            return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
        }  
    }
